...
完整的版本更新记录见 **[Releases](https://github.com/Mininglamp-AI/octoasr/releases)** 页面。
...
# 如果提示 "untrusted tap"，运行: brew trust mininglamp-ai/tap
...
model = AutoModel(
    ...
    vad_model="models/Mininglamp-2718/fsmn-vad-mlx",  # 可选：长音频自动分段
)
